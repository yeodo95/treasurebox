          ...
          children: [
            ...
            Flexible(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Text("보물 상자를 만들기 위해서는", style: new TextStyle(color: Color(0xff616161), fontSize: 16, fontWeight: FontWeight.w500),),
                      Text("로그인이 필요해요", style: new TextStyle(color: Color(0xff616161), fontSize: 16, fontWeight: FontWeight.w500),),
                    ]
                  ),
                )
            ),
